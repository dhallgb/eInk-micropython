...
_cmd_draw_triangle      = b"\xA5\x00\x0F\x28\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xCC\x33\xC3\x3C"
_cmd_fill_triangle      = b"\xA5\x00\x0F\x29\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xCC\x33\xC3\x3C"
_cmd_clear              = b"\xA5\x00\x09\x2E\xCC\x33\xC3\x3C\x82"
_cmd_draw_string        = b"\xA5\x00\x09\x30\x00\x00"
_cmd_draw_bitmap        = b"\xA5\x00\x09\x70\x00\x00"
...
def eink_disp_string(s, x, y):
    bcmd = bytearray(_cmd_disp_string)
    pack_into('!hh',bcmd,4,x,y)
    bcmd.extend(s)
    bcmd.extend('\x00\xCC\x33\xC3\x3C')
    bcmd[2] = len(bcmd)+1
    send(addparity(bcmd))
