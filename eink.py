...
# Doug Hall, 2016
#
# I used a few things to start the conversion from C code into Python:
...
# - Finally used some hints from https://github.com/yy502/ePaperDisplay although this is NOT a fork of that code.
#
...
EPD_NORMAL = 0
EPD_INVERSION = 1
static  unsigned char _cmd_handshake[8] = {0xA5, 0x00, 0x09, CMD_HANDSHAKE, 0xCC, 0x33, 0xC3, 0x3C};
static  unsigned char _cmd_read_baud[8] = {0xA5, 0x00, 0x09, CMD_READ_BAUD, 0xCC, 0x33, 0xC3, 0x3C};
static  unsigned char _cmd_stopmode[8] = {0xA5, 0x00, 0x09, CMD_STOPMODE, 0xCC, 0x33, 0xC3, 0x3C};
static  unsigned char _cmd_update[8] = {0xA5, 0x00, 0x09, CMD_UPDATE, 0xCC, 0x33, 0xC3, 0x3C};
static  unsigned char _cmd_load_font[8] = {0xA5, 0x00, 0x09, CMD_LOAD_FONT, 0xCC, 0x33, 0xC3, 0x3C};
static  unsigned char _cmd_load_pic[8] = {0xA5, 0x00, 0x09, CMD_LOAD_PIC, 0xCC, 0x33, 0xC3, 0x3C};
...
def epd_init(self, void):
    Serial.begin(115200)
    pinMode(wake_up, HIGH)
    pinMode(reset, HIGH)

def epd_reset(self, void):
...
* Attention		   : None
******************************************************************************'''
def epd_set_memory(self, char mode):
    _cmd_buff[0] = FRAME_B
...
* Attention		   : None
******************************************************************************'''
def epd_enter_stopmode(self, void):
...
* Attention		   : None
******************************************************************************'''
def epd_screen_rotation(self, char mode):
    _cmd_buff[0] = FRAME_B
...
'''******************************************************************************
* Function Name  : void epd_set_color(unsigned char color, char bkcolor)
* Description    :
* Input          :
* Output         : None
* Return         :
* Attention		   : None
******************************************************************************'''
def epd_set_color(self, char color, char bkcolor):
    _cmd_buff[0] = FRAME_B
...
* Attention		   : None
******************************************************************************'''
def epd_set_en_font(self, char font):
    _cmd_buff[0] = FRAME_B
...
* Attention		   : None
******************************************************************************'''
def epd_set_ch_font(self, char font):
    _cmd_buff[0] = FRAME_B
...
'''******************************************************************************
* Function Name  : void epd_draw_pixel(int x0, y0)
* Description    :
* Input          :
* Output         : None
* Return         :
...
'''******************************************************************************
* Function Name  : void epd_draw_line(int x0, y0, x1, y1)
* Description    :
* Input          :
* Output         : None
* Return         :
* Attention		   : None
******************************************************************************'''
def epd_draw_line(self, x0, y0, x1, y1):
    _cmd_buff[0] = FRAME_B
...
'''******************************************************************************
* Function Name  : void epd_fill_rect(int x0, y0, x1, y1)
* Description    :
* Input          :
* Output         : None
* Return         :
* Attention		   : None
******************************************************************************'''
def epd_fill_rect(self, x0, y0, x1, y1):
    _cmd_buff[0] = FRAME_B
...
'''******************************************************************************
* Function Name  : void epd_draw_circle(int x0, y0, r)
* Description    :
* Input          :
* Output         : None
* Return         :
* Attention		   : None
******************************************************************************'''
def epd_draw_circle(self, x0, y0, r):
    _cmd_buff[0] = FRAME_B
...
'''******************************************************************************
* Function Name  : void epd_fill_circle(int x0, y0, r)
* Description    :
* Input          :
* Output         : None
* Return         :
* Attention		   : None
******************************************************************************'''
def epd_fill_circle(self, x0, y0, r):
    _cmd_buff[0] = FRAME_B
...
'''******************************************************************************
* Function Name  : void epd_draw_triangle(int x0, y0, x1, y1, x2, y2)
* Description    :
* Input          :
* Output         : None
* Return         :
* Attention		   : None
******************************************************************************'''
def epd_draw_triangle(self, x0, y0, x1, y1, x2, y2):
    _cmd_buff[0] = FRAME_B
...
'''******************************************************************************
* Function Name  : void epd_fill_triangle(int x0, y0, x1, y1, x2, y2)
* Description    :
* Input          :
* Output         : None
* Return         :
* Attention		   : None
******************************************************************************'''
def epd_fill_triangle(self, x0, y0, x1, y1, x2, y2):
    _cmd_buff[0] = FRAME_B
...
'''******************************************************************************
* Function Name  : void epd_disp_char(unsigned char ch, x0, y0)
* Description    :
* Input          :
* Output         : None
* Return         :
* Attention		   : None
******************************************************************************'''
def epd_disp_char(self, char ch, x0, y0):
...
def epd_disp_string(self, * p, x0, y0):
    int string_size
...
def epd_disp_bitmap(self, * p, x0, y0):
    int string_size
    unsigned char ptr = (unsigned char *)p
